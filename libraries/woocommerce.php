...
if ( ! function_exists('wc_hive_get_order_user_id')) :
 ...
 * @return int $user_id
 */
function wc_hive_get_order_user_id($order) {
...
if ( ! function_exists('wc_hive_get_currency_symbol')) :
 ...
 * @return string
 */
function wc_hive_get_currency_symbol() {
